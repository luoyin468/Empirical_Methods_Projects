...
研究者关注的是*平均处理效应(Average Treatment Effect, ATE)*，而非个体效应：
$$\text{ATE}  = E[Y_i(1) - Y_i(0)]$$

更进一步，我们还关注*处理组的平均处理效应（Average Treatment Effect on the Treated, ATT）*：
...
$$\underbrace{E[Y_i | D_i=1] - E[Y_i | D_i=0]}_{\text{观测到的均值差}} = \underbrace{ E[Y_i(1) - Y_i(0) | D_i=1]}_{\text{ATT}}  $$
$$ \quad \quad \quad \quad \quad+ \underbrace{E[Y_i(0)|D_i=1] - E[Y_i(0)|D_i=0]}_{\text{选择偏差}}$$
:::
